...
is the recommended way to run Nexabilis in production: Hostinger patches the
...
[getting-started](./getting-started.md) and [whatsapp-setup](./whatsapp-setup.md) — i.e., your fork builds locally
...
1. **Create repository** → paste your fork's HTTPS URL
   (e.g., `https://github.com/<your-username>/nexabilis.git`).
...
Managed Node.js covers most deploys of Nexabilis. Consider
