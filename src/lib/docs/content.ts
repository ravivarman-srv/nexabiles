...
const ORDER: Record<string, { order: number; section: string; description: string }> = {
  'getting-started': {
    order: 1,
    section: 'Setup',
    description: 'Get started with Nexabilis in a few simple steps.',
  },
  ...
  'deployment-hostinger': {
    order: 5,
    section: 'Deploy',
    description: 'Ship Nexabilis on Hostinger Managed Node.js Hosting.',
  },
...
const CLASSES = {
  h1: 'text-3xl sm:text-4xl font-bold tracking-tight text-foreground mt-1 mb-4 scroll-mt-20',
  h2: 'text-2xl font-semibold tracking-tight text-foreground mt-10 mb-3 pt-6 border-t border-border scroll-mt-20',
  h3: 'text-lg font-semibold text-foreground mt-8 mb-2 scroll-mt-20',
  p: 'my-3 text-muted-foreground leading-relaxed',
  ul: 'my-3 pl-6 list-disc marker:text-muted-foreground text-muted-foreground leading-relaxed space-y-1.5',
  ol: 'my-3 pl-6 list-decimal marker:text-muted-foreground text-muted-foreground leading-relaxed space-y-1.5',
  li: 'pl-1',
  blockquote: 'my-4 rounded-r-lg border-l-4 border-primary bg-primary/5 px-4 py-3 text-primary-foreground',
  hr: 'my-8 border-t border-border',
  a: 'text-primary underline decoration-transparent underline-offset-2 transition-colors hover:decoration-violet-500/60',
  codespan: 'rounded-md border border-border bg-muted px-1.5 py-0.5 text-[0.85em] font-mono text-foreground',
  pre: 'my-5 overflow-x-auto rounded-lg border border-border bg-card/80 p-4 text-[0.825rem] leading-relaxed font-mono text-foreground',
  table: 'my-5 block w-full overflow-x-auto rounded-lg border border-border text-sm',
  th: 'border-b border-border px-3.5 py-2.5 text-left text-xs font-semibold uppercase tracking-wide text-foreground bg-card/60',
  td: 'border-b border-border px-3.5 py-2.5 text-left align-top text-muted-foreground',
