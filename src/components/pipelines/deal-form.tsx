...
export function DealForm({
  ...
  async function handleSave() {
    ...
    if (deal) {
      ...
      const { error } = await supabase
        .from("deals")
        .insert({ ...payload, org_id: user.id, status: "open" });
      if (error) {
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                className="h-9 w-full rounded-lg border border-border bg-muted px-2.5 text-sm text-foreground outline-none focus:border-primary focus:ring-1 focus:ring-violet-500"
              >
