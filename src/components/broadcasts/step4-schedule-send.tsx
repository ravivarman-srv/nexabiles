    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          >
            <Send className={`mt-0.5 h-4 w-4 ${timing === 'now' ? 'text-primary' : 'text-muted-foreground'}`} />
            <div>
          ...
          <div className="relative flex items-start gap-3 rounded-xl border border-border bg-card p-4 opacity-60">
