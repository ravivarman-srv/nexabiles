        ...
        {loading || !contact ? (
          ...
          <div className="flex flex-col h-full">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  onClick={async () => {
                    ...
                    // Navigate to inbox with deep link
                    window.location.href = `/inbox?c=${convId}`;
                  }}
                  size="sm"
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-muted border-b border-border mx-4 mt-3">
                <TabsTrigger
                  value="details"
                ...
                <div className="flex-1 overflow-y-auto space-y-2">
                  {loadingNotes ? (
                    ...
                    notes.map((note) => (
                      <div
                        key={note.id}
                        className="rounded-lg bg-muted border border-border p-3 group"
                      >
