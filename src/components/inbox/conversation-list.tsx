  ...
  return (
    ...
    <div className="flex h-full w-full flex-col border-r border-border bg-card lg:w-80">
      ...
      <div className="flex items-center justify-between px-3 py-3 border-b border-border">
        ...
        <Button variant="ghost" size="icon-sm" asChild className="h-7 w-7 text-muted-foreground hover:text-foreground">
          <Link href="/contacts">
      ...
      <div className="space-y-2 border-b border-border p-3">
        <div className="relative">
          ...
          <Input
            ...
            className="border-border bg-muted pl-9 text-sm text-foreground placeholder-slate-500 focus:border-primary/50"
          />
        </div>
